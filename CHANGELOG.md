...
- `CONTRIBUTING.md` and `SECURITY.md` at the repo root.
- `docs/` folder with user-facing guides: getting-started, providers,
  errors-and-retries, downloads, registries, testing.
